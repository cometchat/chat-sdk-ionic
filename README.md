...
```
npm install @cometchat-pro/cordova-ionic-chat@2.1.1 --save
```
...
```
<script type="text/javascript" src="https://unpkg.com/@cometchat-pro/cordova-ionic-chat@2.1.1/CometChat.js"></script>
```
