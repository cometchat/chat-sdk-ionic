...
```
npm install @cometchat-pro/cordova-ionic-chat@2.0.15 --save
```
...
```
<script type="text/javascript" src="https://unpkg.com/@cometchat-pro/cordova-ionic-chat@2.0.15/CometChat.js"></script>
```
