...
```
npm install @cometchat-pro/cordova-ionic-chat@2.0.13 --save
```
...
```
<script type="text/javascript" src="https://unpkg.com/@cometchat-pro/cordova-ionic-chat@2.0.13/CometChat.js"></script>
```
