...
```
npm install @cometchat-pro/cordova-ionic-chat@2.0.14 --save
```
...
```
<script type="text/javascript" src="https://unpkg.com/@cometchat-pro/cordova-ionic-chat@2.0.14/CometChat.js"></script>
```
